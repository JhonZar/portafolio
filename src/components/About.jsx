...
const About = () => {
  return (
    <section id="about" className="relative w-full h-screen py-20 px-4 gradient-animation text-white flex items-center justify-center">
  <div className="relative z-10 w-full max-w-lg mx-auto text-center glassmorphism p-8">
   <h2 className="text-4xl font-bold mb-4">Sobre Mí</h2>
        <p className="text-lg mb-4">
          Hola, soy [Tu Nombre], un desarrollador web apasionado por crear experiencias digitales únicas y efectivas.
